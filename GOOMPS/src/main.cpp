...
extern "C" void load()
{
    ...
    GorillaUI::Register::RegisterWatchView<SettingsWatchView*>("Goomps Reupload", VERSION);
    GorillaUI::Register::RegisterSettingsView<SettingsWatchView*>("Goomps Reupload", VERSION);
